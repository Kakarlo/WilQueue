...
public class PatientInfo {
    ...
    public String storeToDB(){
        return patientID + "#" + name + "#" + contactInfo + "#" + date + "#" + age + "#" + gender + "#" + address + "#" + occupation + "#" + civilStatus + "#" + nationality + "#" + emergencyContactName + "#" + emergencyContactNumber + "#" + relationship + "#" + allergies + "#" + currMedication + "#" + medicalHistory + "\n";
